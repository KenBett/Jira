// @\features\members\server\route.ts
...
const app = new Hono()
  .get(
    ...
    async (c) => {
      ...
      const members = await databases.listDocuments<Member>(DATABASE_ID, "members", [
  ...
  .patch(
    ...
    async (c) => {
      ...
      await databases.updateDocument(DATABASE_ID, "members", memberId, {
        role,
      });
